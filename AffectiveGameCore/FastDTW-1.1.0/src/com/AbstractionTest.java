...
import src.com.timeseries.PAA;
import src.com.util.DistanceFunction;
import src.com.util.DistanceFunctionFactory;
import src.com.dtw.TimeWarpInfo;
import src.com.dtw.WarpPath;
import src.com.dtw.SearchWindow;
import src.com.dtw.WarpPathWindow;
...
public class AbstractionTest
{
      ...
      public static void main(String[] args)
      {
         ...
         else
         {
            ...
            final WarpPath coarsePath = src.com.dtw.DTW.getWarpPathBetween(shrunkI, shrunkJ, distFn);
            ...
            final TimeWarpInfo info = src.com.dtw.DTW.getWarpInfoBetween(tsI, tsJ, w, distFn);
